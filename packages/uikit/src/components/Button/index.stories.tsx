...
export const Anchors: React.FC<React.PropsWithChildren> = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://zodiacswap.netlify.app" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://zodiacswap.netlify.app" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
