...
export const lightColors = {
  ...
  textSubtle: '#000000',
  disabled: '#E9EAEB',
  gradientBubblegum: 'linear-gradient(139.73deg, #FFFFFF 0%, #F8E8FF 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #F8E8FF 0%, #FFFFFF 100%)',
...
export const darkColors = {
  ...
  textSubtle: '#FFFFFF',
  disabled: '#524B63',
  gradientBubblegum: 'linear-gradient(139.73deg, #000000 0%, #220033 100%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #220033 0%, #000000 100%)',
